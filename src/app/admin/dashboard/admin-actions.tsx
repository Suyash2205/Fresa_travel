  ...
  return (
    <section className="grid gap-4 lg:grid-cols-3">
      ...
      <form onSubmit={importTravellers} className="rounded-xl border border-[#ffd8c8] bg-white p-4 shadow-sm">
        <h3 className="mb-3 text-base font-semibold text-[#1d1d1d]">Import Travellers</h3>
        <div className="space-y-2">
      ...
      {status ? (
        <div className="lg:col-span-3 rounded-md border border-[#ffd8c8] bg-[#fff5f1] px-3 py-2 text-sm text-[#7a3d25]">
          {status}
        </div>
      ) : null}
    </section>
